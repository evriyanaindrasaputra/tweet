  ...
  export const Header = () => {
    return (
      <div className="max-w-7xl relative mx-auto py-24 md:py-32 px-4 w-full  left-0 top-0">
        ...
        <h1 className="text-2xl md:text-7xl font-bold bg-gradient-to-r from-rose-500 via-red-300 to-orange-400 inline-block text-transparent bg-clip-text">
          Home <br /> Korean Drama
        </h1>
        
        <p className="max-w-3xl text-base md:text-xl mt-4 text-neutral-200">
          Crafted with unwavering passion and expertise, every scene unfolds like a masterpiece, beckoning viewers into a realm of endless fascination. From heart-fluttering romances to gripping suspense, Korean dramas offer an enchanting escape into a world where emotions run deep and dreams take flight.
        </p>
      </div>
    );
  };
    ...
    >
      ...
      <Link to={product.link} className="block group-hover/product:shadow-2xl ">
        ...
        <img
          ...
          className="object-cover object-center absolute h-full w-full rounded-sm inset-0"
          alt={product.title}
        />
      </Link>
